#!/usr/bin/env python3
"""
Recuperation des codes promo Nike depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/nike.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/nike.com"
STORE_NAME = "Nike"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Nike depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-nike)"
    }
    try:
